...
class AES_Encrypt(object):
    ...
    def decrypt(self, text):
        ...
        return str(unpad(cipher, AES.block_size), encoding='utf-8')
...
if __name__ == "__main__":
    ...
    for mode in MODE:
        ...
        print('AES Mode: ' + str(mode))
        a = AES_Encrypt(key, mode).encrypt(message)
        print('Encrypted Data: ' + a)
        b = AES_Encrypt(key, mode).decrypt(a)
